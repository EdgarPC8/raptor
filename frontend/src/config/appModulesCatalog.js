...
export const APP_ROLES_LEGEND = [
  ...
  {
    name: "Administrador",
    description: "Gestión completa del negocio: inventario, finanzas, ventas y administración. Tras el login entra al Panel.",
  },
  {
    name: "Empleado",
    description: "Operación diaria: caja, turno, tareas y notificaciones. Tras el login entra directamente a Caja (no al Panel).",
  },
];
...
export const APP_MODULE_GROUPS = [
  {
    id: "acceso",
    label: "Acceso rápido",
    summary: "Vistas principales al iniciar sesión (Administrador → Panel; Empleado → Caja).",
    sections: [
      {
        name: "Panel",
    ...
    sections: [
      ...
      },
      {
        ...
        functions: [
          ...
          { name: "Facturas / notas SRI", description: "Emisión y consulta bajo /comprobantes-electronicos/* desde este hub." },
          { name: "Emitidos y validez SRI", description: "Bandeja de autorizados, pendientes y rechazados." },
        ],
      },
      {
        name: "Facturas",
  ...
  },
  {
    id: "inventario",
    label: "Inventario",
    summary: "Catálogo, stock, sucursales/locales, lotes/vencimientos y (próx.) bodegas.",
    sections: [
      {
        name: "Productos",
  ...
  },
  {
    ...
    label: "Marketing",
    summary:
      "Promociones, catálogo público, grupos comparativos, publicidad y editor. Sin módulo Canal digital aparte.",
    status: "active",
    sections: [
      {
        name: "Promociones",
      ...
      },
      {
        ...
        functions: [
          { name: "Tablero de novedades", description: "Portada con resumen e interiores con el detalle." },
          { name: "Breves y editorial", description: "Avisos cortos y columna de mensaje." },
          { name: "Próximamente", description: "Lo que se va a implementar." },
          { name: "Lectura local", description: "Las noticias se muestran desde la copia del sistema." },
        ],
      },
      {
      ...
      },
      {
        ...
        functions: [
          { name: "Capas e inspector", description: "Diseño libre de la plantilla." },
          { name: "Configuración del molde", description: "Manual/producto/mixto y uso de catálogo en la vista." },
          { name: "Guardar", description: "Persiste la plantilla en base de datos." },
        ],
      },
      {
        name: "Plantillas",
        ...
        functions: [
          ...
          { name: "Crear plantilla", description: "Nueva plantilla vacía con formato 16:9 u otro." },
          { name: "Diseñar", description: "Abre el editor de capas (/editor/:id)." },
          { name: "Usar en vista", description: "Abre la vista con productos con esa plantilla." },
      ...
      },
      {
        ...
        functions: [
          { name: "Selector de plantilla", description: "Por defecto carga la plantilla marcada como default." },
          { name: "Selector de productos", description: "Solo si la plantilla lo requiere." },
          { name: "Exportar", description: "PNG, JPG y PDF. No edita capas ni diseño." },
        ],
      },
    ],
  },
